...
const Stories: React.FC = () => {
    ...
    return (
        <>
            ...
            <>
                <div className="p-4">
                    <h2 className="font-exo text-3xl font-bold">Stories</h2>
                </div>
            </>
            <>
...
// Stories.layout = (page) => <MyLayout>{page}</MyLayout>;
// Define the type for the layout function
type LayoutFn = (page: React.ReactElement) => React.ReactNode;

// Assign the layout function, casting the component to 'any' to allow adding the property
(Stories as any).layout = (page: React.ReactElement): React.ReactNode => <MyLayout>{page}</MyLayout>;
