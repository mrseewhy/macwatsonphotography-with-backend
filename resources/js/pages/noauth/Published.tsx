...
//         // We can safely use non-null assertion here because navigateImage is only called
//         // when selectedImage is not null (due to the rendering logic of the buttons).
...
//             <>
//                 <div className="p-4">
//                     <h2 className="font-exo text-3xl font-bold">Published Works</h2>
//                 </div>
//             </>
//             <>
...
//                     ) : (
//                         <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
//                             {galleryData.map((image: GalleryItem) => (
//                                 <div
//                                     key={image.id}
...
// // Assuming MyLayout is a React functional component that accepts children
// // Published.layout = (page: React.ReactNode): React.ReactNode => <MyLayout>{page}</MyLayout>;
// type LayoutFn = (page: React.ReactElement) => React.ReactNode;

// (Published as any).layout = (page: React.ReactElement) => <MyLayout>{page}</MyLayout>;
...
const Published: React.FC = ({ allPublished: galleryData }) => {
    const [isLoading, setIsLoading] = useState<boolean>(true);
    const [selectedImage, setSelectedImage] = useState<GalleryItem | null>(null);
