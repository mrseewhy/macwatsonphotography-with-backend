...
const ModifiedImageForm = ({ setShowCreate }) => {
    const { data, post, setData, errors, processing, reset } = useForm({
        type: 'link',
        link: '',
        file: null,
        category: 'portraits', // Default category
    ...
    return (
        <div className="mx-auto w-full max-w-xl rounded-lg bg-white p-8">
            <h2 className="mb-8 text-2xl font-bold text-gray-800">Add Image To Landing Page</h2>
